...
define([
    ...
    /**
     * Initializes a new instance of CircuitPlugin.
     * @class
     * @augments {PluginBase}
     * @classdesc This class represents the plugin CircuitPlugin.
     * @constructor
     */
    var CircuitPlugin = function () {
     ...
     * @type {object}
     */
    CircuitPlugin.metadata = pluginMetadata;

    // Prototypical inheritance from PluginBase.
    CircuitPlugin.prototype = Object.create(PluginBase.prototype);
    CircuitPlugin.prototype.constructor = CircuitPlugin;
     ...
     */
    CircuitPlugin.prototype.main = function (callback) {
    ...
    CircuitPlugin.prototype.loadNodeMap = function (node) {
        var self = this;
    ...
    CircuitPlugin.prototype.buildProjectStructure = function (root,nodes) {
        var self = this,
            childrenPath,
            childNode,
            i,
    ...
    CircuitPlugin.prototype.generateArtifact = function (tree, meta) {
        var self = this,
            Q = require('q'),
            deferred = Q.defer(),
            language,
