...
%% Power Source
 vname_p=(data.children.x0x33_.children.x0x30_.children.x0x31_.name);
 vname_p=strcat(vname_p,'1');
 vl_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x31_.L);
 vl_p=num2str(str2num(vl_p)-1);
 vr_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x31_.R);
 vr_p=num2str(str2num(vr_p)-1);
 vval_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x31_.value);
 v_p = {vname_p,vl_p,vr_p,vval_p};
 v1str_p = strjoin(v_p);

%% R1
 r1name_p=(data.children.x0x33_.children.x0x30_.children.x0x35_.name);
 r1l_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x35_.L);
 r1l_p=num2str(str2num(r1l_p)-1);
 r1r_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x35_.R);
 r1r_p=num2str(str2num(r1r_p)-1);
 r1val_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x35_.value);
 r1_p = {r1name_p,r1l_p,r1r_p,r1val_p};
 r1str_p = strjoin(r1_p);
 
 %% R2
 r2name_p=(data.children.x0x33_.children.x0x30_.children.x0x36_.name);
 r2l_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x36_.L);
 r2l_p=num2str(str2num(r2l_p)-1);
 r2r_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x36_.R);
 r2r_p=num2str(str2num(r2r_p)-1);
 r2val_p=num2str(data.children.x0x33_.children.x0x30_.children.x0x36_.value);
...
%% Power Source
 vname_s=(data.children.x0x33_.children.x0x32_.children.x0x35_.name);
 vname_s=strcat(vname_s,'1');
 vl_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x35_.L);
 vl_s=num2str(str2num(vl_s)-1);
 vr_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x35_.R);
 vr_s=num2str(str2num(vr_s)-1);
 vval_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x35_.value);
 v_s = {vname_s,vl_s,vr_s,vval_s};
 v1str_s = strjoin(v_s);

%% R1
 r1name_s=(data.children.x0x33_.children.x0x32_.children.x0x31_.name);
 r1l_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x31_.L);
 r1l_s=num2str(str2num(r1l_s)-1);
 r1r_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x31_.R);
 r1r_s=num2str(str2num(r1r_s)-1);
 r1val_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x31_.value);
 r1_s = {r1name_s,r1l_s,r1r_s,r1val_s};
 r1str_s = strjoin(r1_s);
 
 %% R2
 r2name_s=(data.children.x0x33_.children.x0x32_.children.x0x32_.name);
 r2l_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x32_.L);
 r2l_s=num2str(str2num(r2l_s)-1);
 r2r_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x32_.R);
 r2r_s=num2str(str2num(r2r_s)-1);
 r2val_s=num2str(data.children.x0x33_.children.x0x32_.children.x0x32_.value);
...
% 
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
 if strcmp(probtype,'series+parallel')==1
 %%Series Parallel 1

%% Power Source
 vname_sp=(data.children.x0x33_.children.x0x31_.children.x0x38_.name);
 vname_sp=strcat(vname_sp,'1');
 vl_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x38_.L);
 vl_sp=num2str(str2num(vl_sp)-1);
 vr_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x38_.R);
 vr_sp=num2str(str2num(vr_sp)-1);
 vval_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x38_.value);
 v_sp = {vname_sp,vl_sp,vr_sp,vval_sp};
 v1str_sp = strjoin(v_sp);

%% R1
 r1name_sp=(data.children.x0x33_.children.x0x31_.children.x0x35_.name);
 r1l_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x35_.L);
 r1l_sp=num2str(str2num(r1l_sp)-1);
 r1r_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x35_.R);
 r1r_sp=num2str(str2num(r1r_sp)-1);
 r1val_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x35_.value);
 r1_sp = {r1name_sp,r1l_sp,r1r_sp,r1val_sp};
 r1str_sp = strjoin(r1_sp);
 
 %% R2
 r2name_sp=(data.children.x0x33_.children.x0x31_.children.x0x36_.name);
 r2l_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x36_.L);
 r2l_sp=num2str(str2num(r2l_sp)-1);
 r2r_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x36_.R);
 r2r_sp=num2str(str2num(r2r_sp)-1);
 r2val_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x36_.value);
 r2_sp = {r2name_sp,r2l_sp,r2r_sp,r2val_sp};
 r2str_sp = strjoin(r2_sp); 
 
 %% R3
 r3name_sp=(data.children.x0x33_.children.x0x31_.children.x0x37_.name);
 r3l_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x37_.L);
 r3l_sp=num2str(str2num(r3l_sp)-1);
 r3r_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x37_.R);
 r3r_sp=num2str(str2num(r3r_sp)-1);
 r3val_sp=num2str(data.children.x0x33_.children.x0x31_.children.x0x37_.value);
